...
export type SvgIconName = keyof typeof ICON_DEFINITIONS;

export const SVG_ICONS = ICON_DEFINITIONS;

export function createIconElement(icon: SvgIconName, size = 40): SVGSVGElement {
  const definition = ICON_DEFINITIONS[icon];
...
export function getIconDefinition(icon: SvgIconName): IconDefinition {
  return ICON_DEFINITIONS[icon];
}
